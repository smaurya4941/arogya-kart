...
<body class="bg-background text-on-surface antialiased min-h-screen flex items-center justify-center">
    <div class="text-center px-6 py-20 max-w-lg mx-auto">
        ...
        <div class="flex justify-center mb-6">
            <div class="w-24 h-24 rounded-full bg-primary/10 flex items-center justify-center ring-8 ring-primary/15">
        ...
        {{-- Code --}}
        <p class="text-8xl font-black text-primary tracking-tight leading-none mb-4">404</p>

        {{-- Heading --}}
        <h1 class="text-2xl font-bold text-on-surface mb-3">Page not found</h1>
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
            @auth
                ...
                <a href="{{ route('admin.dashboard') }}"
                   class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-white font-medium hover:bg-primary/90 transition shadow-sm">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
