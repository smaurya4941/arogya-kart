...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-outline-variant text-primary shadow-sm focus:ring-primary/30" name="remember">
                <span class="ms-2 text-sm text-on-surface-variant"><?php echo e(__('Remember me')); ?></span>
            </label>
        </div>

        <div class="flex items-center justify-end mt-6">
            <?php if(Route::has('password.request')): ?>
                <a class="text-sm text-on-surface-variant underline-offset-2 hover:text-on-surface hover:underline" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\sachi\Desktop\arogya-kart\arogya-kart\resources\views/auth/login.blade.php ENDPATH**/ ?>