...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('logout')); ?>">
            ...
            <button type="submit" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary/30">
...
<?php endif; ?>
<?php /**PATH C:\Users\sachi\Desktop\arogya-kart\arogya-kart\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>