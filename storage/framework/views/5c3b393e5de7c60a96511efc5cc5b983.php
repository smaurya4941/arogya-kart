...
<head>
    ...
    <title>403 — Forbidden | <?php echo e(config('app.name', 'ArogyaKart')); ?></title>
...
<body class="bg-slate-50 text-slate-900 antialiased min-h-screen flex items-center justify-center">
    <div class="text-center px-6 py-20 max-w-lg mx-auto">
        ...
        <p class="mt-12 text-sm text-slate-400">
            <?php echo e(config('app.name', 'ArogyaKart')); ?> &mdash; Pharmacy Management
        </p>
    </div>
</body>
</html>
<?php /**PATH C:\Users\sachi\Desktop\arogya-kart\arogya-kart\resources\views/errors/403.blade.php ENDPATH**/ ?>