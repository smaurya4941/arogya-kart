...
<div class="space-y-8">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl shadow-lg p-8 text-white relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="text-5xl font-extrabold mb-6">₹<?php echo e(number_format($todayRevenue, 2)); ?></div>
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                        <div>
                            <p class="text-blue-200 text-sm">Invoices</p>
                            <p class="text-2xl font-bold"><?php echo e($todayInvoices); ?></p>
                        </div>
                        <div>
                            <p class="text-blue-200 text-sm">Items Sold</p>
                            <p class="text-2xl font-bold"><?php echo e($todayItemsSold); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                    ...
                    <div class="text-3xl font-extrabold text-gray-900 dark:text-white mb-4"><?php echo e($totalMedicinesCount); ?></div>
                    <div class="flex justify-between text-sm">
                        <span class="text-green-500 font-medium"><?php echo e($activeMedicines); ?> Active</span>
                        <span class="text-red-500 font-medium"><?php echo e($inactiveMedicines); ?> Inactive</span>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 md:col-span-2">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900 dark:text-white">₹<?php echo e(number_format($monthlyRevenue, 2)); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-500 dark:text-gray-400 text-sm mb-1">Expenses</p>
                            <p class="text-2xl font-bold text-gray-900 dark:text-white">₹<?php echo e(number_format($monthlyExpenses, 2)); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-500 dark:text-gray-400 text-sm mb-1">Net Profit</p>
                            <p class="text-2xl font-bold <?php echo e($netProfit >= 0 ? 'text-green-500' : 'text-red-500'); ?>">₹<?php echo e(number_format($netProfit, 2)); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white flex items-center">
                            ...
                            Low Stock Alerts (<?php echo e($lowStockCount); ?>)
                        </h3>
                    ...
                    <div class="p-0">
                        <?php if($lowStockCount > 0): ?>
                            <ul class="divide-y divide-gray-100 dark:divide-gray-700 max-h-64 overflow-y-auto">
                                <?php $__currentLoopData = $lowStockMedicines->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors flex justify-between items-center">
                                    <div>
                                        <p class="font-medium text-gray-900 dark:text-white"><?php echo e($medicine->name); ?></p>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Min Req: <?php echo e($medicine->min_stock_alert); ?></p>
                                    </div>
                                    <div class="text-right">
                                        <p class="font-bold text-orange-500"><?php echo e($medicine->total_stock); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white flex items-center">
                            ...
                            Expiring Soon (<?php echo e($expiringCount); ?>)
                        </h3>
                        <a href="#" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">View All</a>
                    </div>
                    <div class="p-0">
                        <?php if($expiringCount > 0): ?>
                            <ul class="divide-y divide-gray-100 dark:divide-gray-700 max-h-64 overflow-y-auto">
                                <?php $__currentLoopData = $expiringMedicines->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <li class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors flex justify-between items-center">
                                    <div>
                                        <p class="font-medium text-gray-900 dark:text-white"><?php echo e($batch->product->name ?? 'Unknown'); ?> <span class="text-xs bg-gray-100 dark:bg-gray-600 px-2 py-1 rounded text-gray-600 dark:text-gray-300 ml-2">Batch: <?php echo e($batch->batch_number); ?></span></p>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Qty: <?php echo e($batch->quantity); ?></p>
                                    </div>
                                    <div class="text-right">
                                        <p class="font-bold <?php echo e($textColor); ?>"><?php echo e(ceil($daysLeft)); ?> Days</p>
                        ...
                        <?php if($recentSales->count() > 0): ?>
                            <ul class="space-y-4">
                                ...
                                <li class="flex justify-between items-center text-sm">
                                    <div>
                                        <p class="font-medium text-gray-900 dark:text-white">Invoice #<?php echo e($sale->invoice_number); ?></p>
                                        <p class="text-gray-500"><?php echo e($sale->created_at->diffForHumans()); ?></p>
                                    </div>
                                    <span class="font-bold text-green-600">₹<?php echo e(number_format($sale->total_amount, 2)); ?></span>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        <?php else: ?>
                    ...
                    <div class="p-6">
                        ...
                        <?php if($recentPurchases->count() > 0): ?>
                            <ul class="space-y-4">
                                ...
                                <li class="flex justify-between items-center text-sm">
                                    <div>
                                        <p class="font-medium text-gray-900 dark:text-white">PO #<?php echo e($purchase->invoice_number); ?></p>
                                        <p class="text-gray-500"><?php echo e($purchase->created_at->diffForHumans()); ?></p>
                                    </div>
                                    <span class="font-bold text-red-500">₹<?php echo e(number_format($purchase->total_amount, 2)); ?></span>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        <?php else: ?>
